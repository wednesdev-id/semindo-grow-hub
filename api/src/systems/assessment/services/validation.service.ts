...
export class ValidationService {
    static validateResponse(question: AssessmentQuestion, answer: AnswerValue): ValidationError | null {
        // 1. Check if required
    ...
    private static validateScale(question: AssessmentQuestion, answer: AnswerValue): ValidationError | null {
    ...
    private static validateMultipleChoice(question: AssessmentQuestion, answer: AnswerValue): ValidationError | null {
    ...
    private static validateBoolean(question: AssessmentQuestion, answer: AnswerValue): ValidationError | null {
    ...
    private static validateText(question: AssessmentQuestion, answer: AnswerValue): ValidationError | null {
