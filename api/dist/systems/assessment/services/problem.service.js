...
exports.ProblemMappingService = void 0;
class ProblemMappingService {
    static identifyProblems(assessment, score, responses) {
        const problems = [];
...
exports.ProblemMappingService = ProblemMappingService;
